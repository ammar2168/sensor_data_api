...
public class SensordataApplicationTests {
	...
	@Test
	public void testSensorStatusWARN() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
	...
	@Test
	public void testSensorStatusALERT() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
	...
	@Test
	public void testSensorStatusFromOkToWARN() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
	...
	@Test
	public void testSensorStatusFromWarnToOk() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
		// create measurement for WARN status
	...
	@Test
	public void testSensorStatusFromWarnToAlert() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
		SensorInput sensorInput1 = new SensorInput(2001, "2019-08-09T20:12:47");
		createMeasurement(sensorInput1);
		Thread.sleep(4000);
	...
	@Test
	public void testSensorStatusFromOkToAlert() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
	...
	@Test
	public void testSensorStatusFromAlertToOk() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
		SensorInput sensorInput1 = new SensorInput(2001, "2019-08-09T20:12:47");
		createMeasurement(sensorInput1);
	...
	@Test
	public void testListSensorAlerts() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
	 ...
	 */
	@Test
	public void testSensorLastThirtyDaysMaxandAvg() throws JSONException, InterruptedException {
		TestRestTemplate restTemplate = new TestRestTemplate();
